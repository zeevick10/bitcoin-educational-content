...
_Для написания этой главы я использовал курс [BTC205](https://planb.network/fr/courses/btc205), созданный [@pivi\_\_\_](https://x.com/pivi___) на PlanB Network (пока доступен только на французском языке)._
