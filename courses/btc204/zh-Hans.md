...
*写这一章时，我使用了由[@pivi___](https://x.com/pivi___)在Plan ₿ Network上创建的课程[BTC205](https://planb.network/fr/courses/btc205)（目前仅提供法语版本）。*
...
在这次培训中，我们专门关注了比特币主链上的隐私问题。第二层系统（如闪电网络和侧链）上的隐私问题同样重要，且具有非常特定的特点。尽管使用链下交易可以是一种有效的策略，以规避我们已经研究的比特币上的许多可追踪性风险，但它也会暴露您于其他同样重要的风险。这就是为什么这些话题将在未来专门针对Plan ₿网络的培训中涵盖。
